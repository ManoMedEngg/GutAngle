...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function loadDefaultPatients() {
        const patients = [
            { id: 'P-001', name: 'Raja', age: 45, lastSession: '2024-01-15', status: 'active' },
    ...
    function setupEventListeners() {
        ...
        document.querySelectorAll('.theme-option').forEach(option => {
            option.addEventListener('click', function () {
                ...
                if (theme === 'light') {
                    ...
                    // Auto - remove both to fall back to preference or default
                    document.body.classList.remove('light-theme');
                    document.body.classList.remove('dark-theme');
                }
        ...
        document.querySelectorAll('.color-option').forEach(option => {
            option.addEventListener('click', function () {
                ...
                // Apply color (update CSS variable)
                const root = document.documentElement;
                if (color === 'red') {
                    root.style.setProperty('--primary-red', '#DC2626');
                } else if (color === 'teal') {
                    root.style.setProperty('--primary-red', '#00D4FF'); // Reusing the valid for simplicity/demo
                } else if (color === 'purple') {
                    root.style.setProperty('--primary-red', '#8B5CF6');
                }

                // Save preference (optional, implementing basics)
            });
        });
        ...
        document.querySelectorAll('.font-size-btn').forEach(btn => {
            btn.addEventListener('click', function () {
                ...
                else if (size === 'xlarge') html.style.fontSize = '20px';
            });
        });
